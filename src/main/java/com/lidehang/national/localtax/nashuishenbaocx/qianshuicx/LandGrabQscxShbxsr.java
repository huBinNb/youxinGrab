...
/**
 * 地税--纳税申申报表--欠税查询--社会保险基金收入
 * 
 * @author Hobn
 *
 */
public class LandGrabQscxShbxsr {
...
*/		// http://www.zjds-etax.cn/wsbs/api/sscx/nssb/qs?zsxmDm=10200
		String response = TaxConstants.getMes(httpclient, "http://www.zjds-etax.cn/wsbs/api/sscx/nssb/qs?zsxmDm=10200",
				userId);
		...
		for (Object object : array) {
			...
			new CompanyDataDaoImpl().addData("91330110583235134A", "11009", list);
		}
	...
	private Map<String, Object> parseLssb(JSONObject json) {
		...
		String index = "11009001";
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("serialNumber", "11009");
		for (Object object : array) {
			JSONObject json1 = JsonArrayUtils.objectToJson(object);
