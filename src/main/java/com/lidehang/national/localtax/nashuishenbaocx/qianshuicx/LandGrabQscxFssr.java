...
public class LandGrabQscxFssr {
	public String selectLandTaxByFeestaxes(CloseableHttpClient httpclient,String userId) {
		...
		// http://www.zjds-etax.cn/wsbs/api/sscx/nssb/qs?zsxmDm=10300
*/   	String	response = TaxConstants.getMes(httpclient, "http://www.zjds-etax.cn/wsbs/api/sscx/nssb/qs?zsxmDm=10300",
				userId);
		...
		for (Object object : array) {
			...
			new CompanyDataDaoImpl().addData("91330110583235134A", "11010", list);
		}
		return null;
	}
	...
	private Map<String, Object> parseLssb(JSONObject json) {
		...
		String index="11010001";
		Map<String, Object> map=new HashMap<>();
		map.put("serialNumber", "11010");
		for (Object object : array) {
			JSONObject json1=JsonArrayUtils.objectToJson(object);
