...
/**
 * 地税--纳税申申报表--欠税查询--行政事业性收费收入
 * 
 * @author Hobn
 *
 */
public class LandGrabQscxXzsyxsr {
	public String selectLandTaxByFeestaxes(CloseableHttpClient httpclient,String userId) {
		...
		// http://www.zjds-etax.cn/wsbs/api/sscx/nssb/qs?zsxmDm=30400
	*/	String response = TaxConstants.getMes(httpclient, "http://www.zjds-etax.cn/wsbs/api/sscx/nssb/qs?zsxmDm=30400",
				userId);
		...
		for (Object object : array) {
			...
			new CompanyDataDaoImpl().addData("91330110583235134A", "11013", list);
		}
//		System.out.println(response);
	...
	private Map<String, Object> parseLssb(JSONObject json) {
		...
		String index="11013001";
		Map<String, Object> map=new HashMap<String,Object>();
		map.put("serialNumber", "11013");
		for (Object object : array) {
			JSONObject json1=JsonArrayUtils.objectToJson(object);
