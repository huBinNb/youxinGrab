...
public class LandGrabQscxSssr {
	...
	*/	//http://www.zjds-etax.cn/wsbs/api/sscx/nssb/qs?zsxmDm=10100
		String response = TaxConstants.getMes(httpclient, "http://www.zjds-etax.cn/wsbs/api/sscx/nssb/qs?zsxmDm=10100",userId);
		...
		for (Object object : array) {
			...
			new CompanyDataDaoImpl().addData("91330110583235134A", "11008", list);
		}
//		System.out.println(response);
	...
	private Map<String, Object> parseLssb(JSONObject json) {
		...
		String index="11008001";
		Map<String, Object> map=new HashMap<String,Object>();
		map.put("serialNumber", "11008");
		for (Object object : array) {
			JSONObject json1=JsonArrayUtils.objectToJson(object);
