...
*/		// http://www.zjds-etax.cn/wsbs/api/sscx/nssb/qs?zsxmDm=30200
		String response = TaxConstants.getMes(httpclient, "http://www.zjds-etax.cn/wsbs/api/sscx/nssb/qs?zsxmDm=30200",
				userId);
		...
		for (Object object : array) {
			...
			new CompanyDataDaoImpl().addData("91330110583235134A", "11012", list);
		}
//		System.out.println(response);
	...
	private Map<String, Object> parseLssb(JSONObject json) {
		...
		String index="11012001";
		Map<String, Object> map=new HashMap<String,Object>();
		map.put("serialNumber", "11012");
		for (Object object : array) {
			JSONObject json1=JsonArrayUtils.objectToJson(object);
