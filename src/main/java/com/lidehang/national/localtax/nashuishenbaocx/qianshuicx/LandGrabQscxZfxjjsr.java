...
/**
 * 地税--纳税申申报表--欠税查询--政府性基金收入
 * 
 * @author Hobn
 *
 */
public class LandGrabQscxZfxjjsr {
	public String selectLandTaxByFeestaxes(CloseableHttpClient httpclient,String userId) {
		...
		// http://www.zjds-etax.cn/wsbs/api/sscx/nssb/qs?zsxmDm=30100
	*/  String response = TaxConstants.getMes(httpclient, "http://www.zjds-etax.cn/wsbs/api/sscx/nssb/qs?zsxmDm=30100",
				userId);
		...
		for (Object object : array) {
			...
			new CompanyDataDaoImpl().addData("91330110583235134A", "11011", list);
		}
	...
	private Map<String, Object> parseLssb(JSONObject json) {
		...
		String index="11011001";
		Map<String, Object> map=new HashMap<String,Object>();
		map.put("serialNumber", "11011");
		for (Object object : array) {
			JSONObject json1=JsonArrayUtils.objectToJson(object);
