...
public class LandGrabQscxFmsr {
	...
	public String selectLandTaxByFeestaxes(CloseableHttpClient httpclient,String userId) {
		...
		// http://www.zjds-etax.cn/wsbs/api/sscx/nssb/qs?zsxmDm=30500
	*/	String response = TaxConstants.getMes(httpclient, "http://www.zjds-etax.cn/wsbs/api/sscx/nssb/qs?zsxmDm=30500",
				userId);
		...
		for (Object object : array) {
			...
			new CompanyDataDaoImpl().addData("91330110583235134A", "11014", list);
		}
//		System.out.println(response);
	...
	private Map<String, Object> parseLssb(JSONObject json) {
		...
		String index="11014001";
		Map<String, Object> map=new HashMap<String,Object>();
		map.put("serialNumber", "11014");
		for (Object object : array) {
			JSONObject json1=JsonArrayUtils.objectToJson(object);
