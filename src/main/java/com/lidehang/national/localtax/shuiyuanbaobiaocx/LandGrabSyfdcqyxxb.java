...
/**
 * 地税--税源报表查询--重点税源房地产企业开发经营信息（季报）表
 * @author Hobn
 *
 */
public class LandGrabSyfdcqyxxb {
	...
	*/	//http://www.zjds-etax.cn/wsbs/api/main/sybb/syqy?qsny=201601&sybbDm=SY04&zzny=201612
		String response = TaxConstants.getMes(httpclient, "http://www.zjds-etax.cn/wsbs/api/main/sybb/syqy?qsny=201601&sybbDm=SY04&zzny=201612",userId);
		...
		for (Object object : array) {
			...
			new CompanyDataDaoImpl().addData("91330110583235134A", "11025", list);
		}
	...
	private Map<String, Object> parseLssb(JSONObject json) {
		...
		String index="11025001";
		Map<String, Object> map=new HashMap<String,Object>();
		map.put("serialNumber", "11025");
		for (Object object : array) {
			JSONObject json1=JsonArrayUtils.objectToJson(object);
