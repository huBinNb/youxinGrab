...
/**
 * 地税--税源报表查询--重点税源企业税收信息
 * @author Hobn
 *
 */
public class LandGrabSyqyssxx {
	...
	*/	//http://www.zjds-etax.cn/wsbs/api/main/sybb/syqy?qsny=201601&sybbDm=SY01&zzny=201612
		String response = TaxConstants.getMes(httpclient, "http://www.zjds-etax.cn/wsbs/api/main/sybb/syqy?qsny=201601&sybbDm=SY01&zzny=201612",userId);
		...
		for (Object object : array) {
			...
			new CompanyDataDaoImpl().addData("91330110583235134A", "11022", list);
		}
//		System.out.println(response);
	...
	private Map<String, Object> parseLssb(JSONObject json) {
		...
		String index="11022001";
		Map<String, Object> map=new HashMap<String,Object>();
		map.put("serialNumber", "11022");
		for (Object object : array) {
			JSONObject json1=JsonArrayUtils.objectToJson(object);
